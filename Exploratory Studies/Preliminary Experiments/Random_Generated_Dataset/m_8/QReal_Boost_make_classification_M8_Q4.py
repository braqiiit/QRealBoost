...
# The make_classification function was run in a seperate file named, where a total of 64 samples with 2 features each were generated and the Testing and Training for this experiment were sampled from those points
...
y_test = np.array([1, 0 ,1 ,1 ,1 ,1 ,0 ,0])

print("..............................")
print("this is GOOD Make Class, this has got 2G!!! , M=16, Q = 4, T = 20")
...
def Oh_Dbk_custom_new_inv(qc, qr1, qr_list, data_dict):
    ...
    for i in range(data_size):
        ...
        # the main idea is that the oracle looks at the all the values of xi and the corresponding jti that it wants to  
