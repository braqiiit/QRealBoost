...
# 
# New implementation without QRAM, and with amplification and estimation, submitted to TQC'22 conference 
...
def numConcat(num1, num2): 
    ...
    '''
    this should actually do all the additions in the form of strings and then when you finally
